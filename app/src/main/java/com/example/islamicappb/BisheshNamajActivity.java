    ...
    private HashMap<String, PojoClassForKalima> getContactos() {
        ...
        if (ff.equals("1")){
            ...
            listaC.put("৪", new PojoClassForKalima("জুমআ",
                    "প্রতি শুক্রবার যোহরের নামাজের ওয়াক্তে যোহরের নামাজের পরিবর্তে জুমআর নামাজ পড়তে হয়।",
                    " জুমআর নামাজ ফরজে আইন।",
                    "জুমআর নামাজ মোট বার রাকাআত, খুতবার আগে চার রাকাআত সুন্নতে মুয়াক্কাদা (কাবলুল জুমআ), খুতবার পরে জামাআতের সাথে দুই রাকাআত ফরজ, আর ফরজ নামাজের পরে আরও চার রাকাআত সুন্নতে মুয়াক্কাদা (বা’দুল জুমআ) এবং সবশেষে দুই রাকাআত সুন্নতে মুয়াক্কাদা পড়তে হয়। নিচে জুমআর নামাজ আদায় করার নির্দেশনাগুলো দেওয়া হল।\n" +
                            "জুমআর দুই রাকআত ফরজ নামাজ সাধারণ ফরজ নামাজের মতই। মসজিদে খুতবা শুরুর আগেই গিয়ে কাবলুল জুমআর জন্য নিয়ত করে চার রাকাআত সুন্নতে মুয়াক্কাদা নামাজ একা পড়ে নিতে হবে। তারপরে দ্বিতীয় আজান দেওয়া হবে এবং আজান শেষে খতিব খুতবা শুরু করবে। খুতবা শোনা ওয়াজিব, এই সময়ে তাহিয়্যাতুল মসজিদ নামাজ ব্যতীত অন্য কোনো নামাজ না পড়াই উত্তম। খুতবার সময় কারো সাথে কথা বলা বা খুতবা শুনতে ব্যঘাত ঘটে এমন কোনো কাজ করা হারাম। খুতবা শেষ হলে ফরজ নামাজের জন্য জামাআতে দাঁড়াতে হবে এবং ইমামের সাথে পড়তে হবে। ফরজ নামাজ শেষ হলে মুনাজাত হবে। মুনাজাতের পরে চার রাকাআত ও দুই রাকাআত সুন্নতে মুয়াক্কাদা একা পড়ে নিতে হবে।\n"));
            ...
            listaC.put("৭", new PojoClassForKalima("তাহাজ্জুদ",
                    ...
                    "তাহাজ্জুদ একটি গুরুত্বপূর্ণ নফল নামাজ।",
                    " এই নামাজের সময় বা পরে করা ইস্তিগফার ও দুয়া কবুল হওয়ার সম্ভাবনা বেশি, কারণ তাহাজ্জুদ আল্লাহ্\u200Cর বান্দাকে আল্লাহ্\u200Cর নিকটবর্তী ও প্রিয়তর করে। নিয়মিত তাহাজ্জুদ পড়লে আল্লাহ্\u200Cর সন্তুষ্টি ও রহমত লাভ করা যায়। রাতের দুই তৃতীয়াংশ অতিবাহিত হওয়ার পর এবং ফযরের ওয়াক্ত শুরু হওয়ার আগে তাহাজ্জুদের নামাজ পড়তে হয়। তাহাজ্জুদের রাকাআত সংখ্যা নির্দিষ্ট না। কমপক্ষে দুই রাকাআত থেকে বার রাকাআত পর্যন্ত পড়া যায়। দুই রাকাআত করে ভেঙ্গে ভেঙ্গে পড়তে হবে। \n",
