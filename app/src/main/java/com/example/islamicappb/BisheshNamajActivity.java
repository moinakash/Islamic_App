    ...
    private HashMap<String, PojoClassForKalima> getContactos() {
        ...
        if (ff.equals("1")){
            ...
            listaC.put("৫", new PojoClassForKalima("ঈদের নামাজ",
                    " প্রতি বছর উভয় ঈদের দিন সকালে ঈদগাহে অথবা মসজিদে জামআতের সাথে দুই রাকআত নামাজ পড়তে হয়। ঈদুল ফিতর ও ঈদুল আযহা এই দুই ঈদের নামাজের নিয়ম একই। কেবল নিয়ত ভিন্ন হবে। উভয় ঈদের নামাজই ওয়াজিব। ঈদের নামাজ দুই রাকাআত। নিচে ঈদের নামাজ আদায় করার নির্দেশনাগুলো দেওয়া হল।\n" +
                            "\n" +
